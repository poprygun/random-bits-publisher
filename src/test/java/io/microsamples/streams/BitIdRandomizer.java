...
public class BitIdRandomizer implements Randomizer<String> {

    private List<String> sampleIds = Arrays.asList(
    ...
    public String getRandomValue() {
        return sampleIds.get(new Random().nextInt(sampleIds.size()));
    }
}
